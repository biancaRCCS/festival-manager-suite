...
import { ArrowLeft, CheckCircle2, XCircle, MapPin, Mail, Phone, Clock } from "lucide-react"
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-y-4 gap-x-6">
                ...
                <div>
                  ...
                  <p className="text-sm">{new Date(vendor.createdAt).toLocaleString()}</p>
                </div>
                <div>
                  <h4 className="text-sm font-medium text-muted-foreground mb-1 flex items-center gap-1.5">Status</h4>
                  <Badge variant="outline" className="capitalize">{vendor.status.replace('_', ' ')}</Badge>
                </div>
              </div>
              ...
              <div className="border-t pt-6 mt-6">
                ...
                <div className="space-y-4">
                  {Object.entries(vendor.applicationData || {}).map(([key, value]) => (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {vendor.paidAt ? 
                    <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Paid on {new Date(vendor.paidAt).toLocaleDateString()}</Badge> : 
                    <Badge variant="secondary">Pending</Badge>
                  }
                </div>
                {vendor.reviewNote && (
