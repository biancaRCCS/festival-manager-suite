...
export default function ApplySponsorSuccessPage() {
  return (
    <PublicLayout title="Payment Received!" subtitle="Thank you for sponsoring the Romanian Festival.">
      <Card className="border-t-4 border-t-primary shadow-lg bg-card/90 backdrop-blur">
        <CardContent className="p-10 flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-md">
            Your payment has been received and your sponsorship application is now under
            review. Our team will confirm your sponsorship shortly and email you with next
            steps, including a link to submit your booth and promotional details.
          </p>
          <Link href="/">
