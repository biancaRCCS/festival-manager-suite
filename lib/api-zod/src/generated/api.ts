...
export const createManualContributionBodyOneAmountMax = 99999999.99;
...
export const CreateManualContributionBody = zod.object({
  ...
  "amount": zod.number().gt(createManualContributionBodyOneAmountExclusiveMin).max(createManualContributionBodyOneAmountMax),
...
export const recordVendorManualPaymentBodyAmountMax = 99999999.99;
...
export const RecordVendorManualPaymentBody = zod.object({
  "method": zod.enum(['cash', 'check', 'bank_transfer', 'other']),
  "amount": zod.number().gt(recordVendorManualPaymentBodyAmountExclusiveMin).max(recordVendorManualPaymentBodyAmountMax),
  "receivedDate": zod.coerce.date(),
 ...
 */
export const ReconcileVendorStatusFromTimestampsParams = zod.object({
  "id": zod.coerce.number()
})

export const reconcileVendorStatusFromTimestampsResponseSpecialAgreementSettlementVersionMin = 0;



export const ReconcileVendorStatusFromTimestampsResponse = zod.object({
  "id": zod.number(),
  "yearId": zod.number(),
  "name": zod.string(),
  "businessName": zod.string(),
  ...
  "specialAgreementSettlementStatus": zod.enum(['awaiting_figures', 'calculated', 'paid']).optional(),
  "specialAgreementSettlementNotes": zod.string().nullish(),
  "specialAgreementSettlementVersion": zod.number().min(reconcileVendorStatusFromTimestampsResponseSpecialAgreementSettlementVersionMin).optional(),
  "approvedAt": zod.string().nullish(),
  "finalApprovedAt": zod.string().nullish(),
  "createdAt": zod.string()
})
...
export const recordSponsorManualPaymentBodyAmountMax = 99999999.99;
...
export const RecordSponsorManualPaymentBody = zod.object({
  "method": zod.enum(['cash', 'check', 'bank_transfer', 'other']),
  "amount": zod.number().gt(recordSponsorManualPaymentBodyAmountExclusiveMin).max(recordSponsorManualPaymentBodyAmountMax),
  "receivedDate": zod.coerce.date(),
 ...
 */
export const ReconcileSponsorStatusFromTimestampsParams = zod.object({
  "id": zod.coerce.number()
})

export const ReconcileSponsorStatusFromTimestampsResponse = zod.object({
  "id": zod.number(),
  "yearId": zod.number(),
  "name": zod.string(),
  "orgName": zod.string(),
